	...
	if(isset($_POST['submit']))
		...
		if($count>0)
		{
		  ...
		  if($_SESSION['Role']!="opertor" && $_SESSION['Role']!="admin2"){
			header("Location:registration.php?msg=create user here");
                  }else{
                      	header("Location:login.php?msg=you don't have authurizations");
...
<body id="login-body">
  ...
  <div id="login">
    <!-- BEGIN LOGIN FORM -->
    <form class="form-vertical no-padding no-margin" action="" method="post">
      <div class="lock">
          <i class="icon-lock"></i>
      </div>
              ...
              <div class="controls">
                  ...
                  <div class="mtop10">
                      <div class="block-hint pull-left small">
                          <a href=".php" style="font-size:12px;"></a>
      ...
      <input type="submit" name="submit" class="btn btn-block login-btn" value="Create User" />
