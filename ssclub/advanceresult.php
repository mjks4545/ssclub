<?php      
			...
			if($_GET['nic'] ||  $_GET['card'] || $_GET['booth'] || $_GET['name'] || $_GET['weaponname'] || $_GET['from'] || $_GET['weapon'] || $_GET['to'] ||  $_GET['fire'] || $_GET['membership'] || $_GET['regno'] || $_GET['guestnic']||$_GET['mobile'])
			{
                             ...
                             if($mobile)
                             {
				    $query=mysql_query("select * from `checkin` where `TelephoneNo`='$mobile'") or die();
                             }
...
<table width="1109" border="1" align="center" style="color:#000;font-size:14px;">
  <tr style="background:#CCC">
	...
	<th width="144" scope="col">LicenseNO</th>
...
<?php 	}?>
        	...
        	<?php		
            			...
            			if(empty($_GET['nic']) && empty($_GET['card']) && empty($_GET['booth']) && empty($_GET['name']) && empty($_GET['weaponname']) && empty($_GET['from']) && empty($_GET['weapon']) && empty($_GET['to']) && empty($_GET['fire']) && empty($_GET['membership']) && empty($_GET['regno']) && empty($_GET['guestnic']) && empty($_GET['mobile']))
						{
