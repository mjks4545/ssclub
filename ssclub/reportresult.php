...
<table class="responstable">
    ...
    <th width="72" scope="col">QTY</th>
    <th width="54" scope="col">Rate</th>
    <th width="58" scope="col">Total</th>
    <th width="65" scope="col">Pr Price</th>
  ...
  <tr align="center">
    ...
    <td><?php echo $row['Quantity'];  $qtyshenz+=$row['Quantity'];  ?></td>
  ...
  <?php $i++;}}?>
   <!----end of second row---second table product model and type querires--->
    ...
    <td width="60"><?php echo $row4['weapon_no'];?></td>
  ...
  <!--NIC in 2nd table--> 
    ...
    <td width="60"><?php echo $row5['weapon_no'];?></td>
...
<!--bill no in 2nd table--> 
  ...
  <?php $i++;}}?>
   <!--date from entries in 2nd table--> 
    ...
    <td><?php echo $row4['LicenseNo'];?></td>
    <td width="60"><?php echo $row5['weapon_no'];?></td>
    <td><?php echo $row5['qty']; $qtyshenz1+=$row5['qty'];?></td>
    <td><?php echo $row5['rate'];?></td>
    <td><?php echo $row5['total'];?></td>
    <td><?php echo $row7['price']*$row5['qty'];?></td>
    <td><?php echo $row4['Date'];?></td>
...
<table style="width: 400px;margin: 0 auto;" class="responstable">
    <tr>
      ...
      <tr>
    <td><?php echo $qty1+$qty2+$qty3+$qty4+$qty5+$qty6+$qty7+$qty8+$qty9;?></th>
    <td><?php echo $rate1+$rate2+$rate3+$rate4+$rate5+$rate6+$rate7+$rate8+$rate9;?></td>
    <td><?php echo $tot1+$tot2+$tot3+$tot4+$tot5+$tot6+$tot7+$tot8+$tot9;?></td>
    <td><?php  echo $price1+$price2+$price3+$price4+$price5+$price6+$price7+$price8+$price9;?></td>
  </tr>
</table>
...
//var stickyOffset = $('#sticky').offset().top;
  ...
  if (scroll >= 300) sticky.addClass('fixed3');
