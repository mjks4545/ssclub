...
<div style="margin-top:0px;color:#000" align="center"><h4 style="margin-bottom:50px">Sales Report</h4></div>
<table width="1280" border="1" align="center" style="color:#000;">
 <tr style="position:fixed;background:#CCC;margin-top:-50px;">
 <td colspan="12">
 	<table width="1278" border="1">
 	  <tr style="background:#CCC">
    <th width="15" height="33" scope="col">S.NO</th>
    <th width="30" scope="col"><?php if($_GET['by']==""){?><a href="store.php?page=reportempty&by=asc">Bill#</a><?php }?><?php if(isset($_GET['by'])=='asc'){?><a href="store.php?page=reportempty&by=desc">Bill#</a><?php }?></th>
    <th width="295" scope="col">Name</th>
    <th width="100" nowrap="nowrap" scope="col">Product</th>
    <th width="170" scope="col" nowrap="nowrap">Product Type</th>
    <th width="160" scope="col" nowrap="nowrap">
    <?php if($_GET['bymodel']==""){?><a href="store.php?page=reportempty&bymodel=asc">Product Model</a><?php }?>
   <?php if(isset($_GET['bymodel'])=="asc"){?> <a href="store.php?page=reportempty&bymodel=desc">Product Model</a><?php }?>
    </th>
    <th width="100" scope="col" nowrap="nowrap">License NO</th>
    <th width="65" scope="col">Quantity</th>
    <th width="50" scope="col">Rate</th>
    <th width="60" scope="col">Total</th>
    <th width="60" scope="col" nowrap="nowrap">Purchase price</th>
  ...
  <tr align="center">
    ...
    <td width="30"><?php echo $row9['sb_id'];?></td>
    ...
    <td width="100"><?php echo $row1['LicenseNo'];?></td>
    <td width="60"><?php echo $row1['Quantity'];?></td>
    <td width="50"><?php echo $row1['Amount'];?></td>
    <td width="60"><?php echo $row1['total'];?></td>
    <td width="60"><?php echo $row5['price']*$row1['Quantity'];?></td>
...
<table width="250" height="27" border="1" style="float:right;margin-right:100px;">
  <tr align="center">
  	<th width="58" scope="row"><?php echo $qty+$qty1;?></th>
    <td width="50"><?php echo $rate+$rate1;?></td>
    <td width="58"><?php echo $total1+$total2;?></td>
    <th width="66" scope="row"><?php echo $tpurchase_price+$t_price;?></th>
  </tr>
 </table>
<?php }?>