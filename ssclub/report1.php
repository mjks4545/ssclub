...
<table width="1095" border="1" align="center" style="color:#000">
  ...
  <tr align="center">
    ...
    <td><a class="one" href="store.php?page=editsale&amp;id=<?php echo $row['Sid'];?>"><?php echo $row['Cname'];?></a><div class="two" ><?php echo $row['Cname'];?></div></td>
  ...
  ?>
   <tr align="center">
    ...
    <td><a class="one" href="store.php?page=editsale&id=<?php echo $row1['Sid'];?>"><?php echo $row1['Cname'];?></a><div class="two"><?php echo $row1['Cname'];?></div></td>
