...
<div class="container">
	<section id="content">
		<form id="loginform" action="" method="post">
			<h1>User Login</h1>
			<div>
                            <input type="text" placeholder="Username" required="" id="input-username" name="username" />
			</div>
			<div>
				<input type="password" placeholder="Password" required="" id="input-password" name="password" />
			</div>
			<div>
				<input type="submit" name="submit" id="login-btn" value="Log in" />
				<a href="login1.php">Create New user</a>
			</div>
		</form><!-- form -->
