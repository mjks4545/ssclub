    ...
    <div id="table" align="center" >
              ...
              <table width="1109" border="1">
                ...
                <tr>
                  ...
                  <td align="center" nowrap="nowrap"><?php if(isset($_GET['id'])) { echo $row['SubProduct'];}?>&nbsp;/&nbsp;<?php if(isset($sid)){ echo $row['pmodel'];}?>/<?php if(isset($_GET['id']) && $row['Product']==='Fire Arms'){ echo $row['weapon_no'];}?></td>
